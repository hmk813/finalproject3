...
<ul class="pagination">
   <c:choose>
      ...
      <c:otherwise>
         <li class="page-item">
            <a class="page-link" href = "list?p=${list.blockFirst()}&${list.queryString()}">&laquo;</a>
         </li>
      </c:otherwise>
   </c:choose>
   
   <c:choose>
      <c:when test = "${list.hasPrev()}">
         <li class="page-item">
            <a class="page-link" href = "list?p=${list.blockPrev()}&${list.queryString()}">&lt;</a>
         </li>
      </c:when>
      <c:otherwise>
         <li class="page-item">
   ...
   <c:forEach var = "i" begin = "${list.blockStart()}" end = "${list.blockEnd()}" step = "1">
      <li class="page-item">
         <a class="page-link" href = "list?p=${i}&${list.queryString()}">${i}</a>
      </li>
   </c:forEach>
   ...
   <c:choose>
      <c:when test = "${list.hasNext()}">
         <li class="page-item">
            <a class="page-link" href = "list?p=${list.blockNext()}&${list.queryString()}">&gt;</a>
         </li>
      </c:when>
      <c:otherwise>
         <li class="page-item">
   ...
   <c:choose>
      ...
      <c:otherwise>
         <li class="page-item">
            <a class="page-link" href = "list?p=${list.blockLast()}&${list.queryString()}">&raquo;</a>
         </li>
      </c:otherwise>
   </c:choose>
</ul>
