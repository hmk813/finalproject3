    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">우가우가병원<sup>2</sup></div>
            </a>
           ...
           <li class="nav-item">
               ...
               <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                   <div class="bg-white py-2 collapse-inner rounded">
                       <a class="collapse-item" href="buttons.html">내과</a>
                       <a class="collapse-item" href="cards.html">외과</a>
                       <a class="collapse-item" href="buttons.html">정형외과</a>
                       <a class="collapse-item" href="cards.html">방사선과</a>
                   </div>
               </div>
           </li>
