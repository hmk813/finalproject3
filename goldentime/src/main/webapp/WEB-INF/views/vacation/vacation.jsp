                ...
                function vacationList() {
                    ...
                    $.ajax({
                        ...
                        success: function (resp) {
                            ...
                            $("#leaveCnt1").html('<i class="fa-solid fa-circle fa-xs circleSize"></i> 남은 연차 수 &nbsp&nbsp')
                            $("#leaveCnt1").append(resp[resp.length - 1].staffLeaveCnt - useCnt);
                            $("#leaveCnt1").append(' 일')

                            $("#dayoff1").html('<i class="fa-solid fa-circle fa-xs circleSize"></i> 총 월차 수 &nbsp&nbsp')
                            $("#dayoff1").append(resp[resp.length - 1].staffDayoff)
                            $("#dayoff1").append(' 일')

                            $("#dayoff2").html('<i class="fa-solid fa-circle fa-xs circleSize"></i> 남은 월차 수 &nbsp&nbsp')
                            $("#dayoff2").append(resp[resp.length - 1].staffDayoff - useCnt1)
                            $("#dayoff2").append(' 일')
                            page();
                        }
                    });
